...
public class CRMCommandQuerysTest {
    ...
    void setUp() {
        ...
        opportunity2 = new Opportunity(Product.FLATBED,39, contact2, salesRep2, account2);
    ...
    @Test
    void menuActions_MaxEmployeeCount() throws InterruptedException {
        String result = "Maximum number of Employee count: " + 456;
        crmMenu.menuActions(Command.MAX_EMPLOYEECOUNT,-1L);
        assertEquals(result, outContent.toString().trim());
    }

    @Test
    void menuActions_MeanEmployeeCount() throws InterruptedException {
        String result = "Mean number of Employee count: " + 256.0;
        crmMenu.menuActions(Command.MEAN_EMPLOYEECOUNT,-1L);
        assertEquals(result, outContent.toString().trim());
    }

    @Test
    void menuActions_MedianEmployeeCount() throws InterruptedException {
        String result = "Median number of Employee count: " + 256.0;
        crmMenu.menuActions(Command.MEDIAN_EMPLOYEECOUNT,-1L);
        assertEquals(result, outContent.toString().trim());
    }

    @Test
    void menuActions_MinEmployeeCount() throws InterruptedException {
        String result = "Minimum number of Employee count: " + 56;
        crmMenu.menuActions(Command.MIN_EMPLOYEECOUNT,-1L);
        assertEquals(result, outContent.toString().trim());
    }

    @Test
    void menuActions_MaxQuantity() throws InterruptedException {
        String result = "Maximum quantity of products: " + 9356;
        crmMenu.menuActions(Command.MAX_QUANTITY,-1L);
        assertEquals(result, outContent.toString().trim());
    }
    @Test
    void menuActions_MeanQuantity() throws InterruptedException {
        String result = "Mean quantity of products: " + 3139.0;
        crmMenu.menuActions(Command.MEAN_QUANTITY, -1L);
        assertEquals(result, outContent.toString().trim());
    }

    @Test
    void menuActions_MedianQuantity() throws InterruptedException {
        String result = "Median quantity of products: " + 39.0;
        crmMenu.menuActions(Command.MEDIAN_QUANTITY, -1L);
        assertEquals(result, outContent.toString().trim());
    }

    @Test
    void menuActions_MinQuantity() throws InterruptedException {
        String result = "Minimum quantity of products: " + 22;
        crmMenu.menuActions(Command.MIN_QUANTITY, -1L);
        assertEquals(result, outContent.toString().trim());
    }

    @Test
    void menuActions_MaxOppPerAccount() throws InterruptedException {
        String result = "Maximum number of Opportunities associated with an Account: "  + 2;
        crmMenu.menuActions(Command.MAX_OPPS_PER_ACCOUNT,-1L);
        assertEquals(result, outContent.toString().trim());
    }
    @Test
    void menuActions_MeanOppPerAccount() throws InterruptedException {
        String result = "Mean number of Opportunities associated with an Account: " + 1.5;
        crmMenu.menuActions(Command.MEAN_OPPS_PER_ACCOUNT, -1L);
        assertEquals(result, outContent.toString().trim());
    }


    @Test
    void menuActions_MinOppPerAccount() throws InterruptedException {
        String result = "Minimum number of Opportunities associated with an Account: "  + 1;
        crmMenu.menuActions(Command.MIN_OPPS_PER_ACCOUNT, -1L);
        assertEquals(result, outContent.toString().trim());
    }
